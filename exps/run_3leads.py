...
from model.vgg import VGG16Model, VGG19Model
from model.resnet import ResNet50, ResNetTest
...
def run():
    ...
    for i in range(exprm_num):
        ...
        # 存模型
        model_path = '../../result/20210402/lead3_v2_' + str(i) + '.h5'
        model.save(model_path)

        # 存数据
        data_path = '../../result/20210402/lead3_v2_' + str(i) + '.csv'
    ...
    data_path_s = '../../result/20210402/lead3_v2.csv'
